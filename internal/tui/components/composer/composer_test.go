...
var (
	inputSelectSt      = lipgloss.NewStyle().Reverse(true)
	forkSelectInputSt  = lipgloss.NewStyle().Foreground(lipgloss.Color("205"))
	messageEditInputSt = lipgloss.NewStyle().Foreground(lipgloss.Color("214"))
	mutedSt            = lipgloss.NewStyle().Faint(true)
)

func init() {
	ConfigureStyles(mutedSt, inputSelectSt, []lipgloss.Style{lipgloss.NewStyle().Reverse(true)})
}
